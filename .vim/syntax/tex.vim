...
syn region texRefZone		matchgroup=texStatement start="\\prettyref{"		end="}\|%stopzone\>"	contains=@texRefGroup
syn region texRefZone		matchgroup=texStatement start="\\inCode{"		end="}\|%stopzone\>"	contains=@texRefGroup
